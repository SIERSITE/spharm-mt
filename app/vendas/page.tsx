...
const mockRows: SalesReportRow[] = [
  {
    codigo: "5440987",
    descricao: "BEN-U-RON COMP 1 G X 18",
    pvp: 3.09,
    jan: 40,
    fev: 22,
    mar: 25,
  ...
  {
    codigo: "2401180",
    descricao: "Nebilet Comp 5 mg x 28",
    pvp: 11.7,
    jan: 17,
    fev: 11,
    mar: 9,
  ...
  {
    codigo: "5674239",
    descricao: "Skudexa 75 mg + 25 mg x 20",
    pvp: 18.5,
    jan: 11,
    fev: 9,
    mar: 13,
...
export default function VendasPage() {
  const farmacias = Array.from(new Set(mockRows.map((r) => r.farmacia)));
