...
SPHARMMT_OPERATIONAL_SCRIPTS="bootstrap-vps.sh install-docker.sh install-platform.sh prepare-data-disk.sh verify-platform.sh update-platform.sh deploy-app.sh backup-platform.sh restore-platform.sh healthcheck.sh backlog-knowledge.sh"
